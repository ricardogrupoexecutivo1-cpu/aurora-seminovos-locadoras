...
export default function SeminovosEmpresaPublicaPage({ params }: PageProps) {
  ...
  useEffect(() => {
    ...
    async function loadCompany() {
      try {
        ...
        if (!found) {
          throw new Error("Empresa não encontrada na base.");
        }
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
              <div className="max-w-3xl">
                ...
                <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600 sm:text-base">
                  Visual público premium para apresentar empresas cadastradas na
                  base comercial. Sistema em constante atualização e pode haver
